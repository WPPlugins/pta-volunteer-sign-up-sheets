...
*	Use the free PTA Shortcodes extension to easily generate shortcodes with all possible arguments ( available at https://wordpress.org/plugins/pta-shortcodes/ )
